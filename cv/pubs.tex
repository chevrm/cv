...
\cvpub
{F Zhang, M Zhao, DR Braun, A Audhya, SS Ericksen, JS Piotrowski, J Nelson, J Peng, GE Ananiev, S Chanana, K Barns, J Fossen, \textbf{MG Chevrette}, IA Guzei, C Zhao, L Guo, W Tang, CR Currie, SR Rajski, DR Andes, TS Bugni. ``Marine microbiome discovery of antifungal targeting urgent threat drug-resistant fungi." \textit{In press, \textbf{Science}.}}
{20}
...
\cvpub
{A Hurley, \textbf{MG Chevrette}, D Acharya, W Chezem, G Lozano, M Garavito, J Heinritz, L Balderrama, M Beebe, ML DenHartog, K Corinaldi, R Engels, A Gutierrez, O Jona, JHI Putnam, B Rhodes, T Tsang, S Hernandez, C Bascom-Slack, D Davis, J Klein, T Martinez, J Pultorak, N Sullivan, S Miller, N Broderick, J Handelsman. ``Research courses for all college students." \textit{Submitted.}}
{5}

\cvpub
{MA Schorn*, S Verhoeven*, et al. [104 authors including \textbf{MG Chevrette}]. ``Standardized links between genomic and metabolomic data facilitate integrative mining." \textit{Submitted.}}
{4}
...
\cvpub
{\textit{TBD}. International Symposium on the Biology of Actinomycetes. Toronto, ON. Originally scheduled for Jun 23, 2020. Postponed due to COVID-19.}
{10}
