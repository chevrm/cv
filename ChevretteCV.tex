...
\cvitem{}{\textbf{Chevrette, MG}, F Aicheler, O Kohlbacher, CR Currie, MH Medema.  \textit{In preparation}. "Ensemble Computational Predictions of NRPS Adenylation Domain Substrate Specificities."} \vspace{1.5mm}
\cvitem{}{Lewin, GR, AJ Book, RJ Stankey, C Carlos, \textbf{MG Chevrette}, BR McDonald, CR Currie.  \textit{In preparation}.  "Ecology and Evolution of Actinobacteria and their Bioenergy Applications."} \vspace{1.5mm}
\cvitem{}{Johnson, SS, \textbf{MG Chevrette}, BL Ehlmann, KC Benison.  2015.  "Insights from the Metagenome of an Acid Salt Lake: the Role of Biology in an Extreme Depositional Environment."  \textit{PLOS ONE}.  2015 Apr; \textbf{10}(4):e0122869.} \vspace{1.5mm}
